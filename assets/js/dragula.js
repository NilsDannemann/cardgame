...
document.addEventListener("DOMContentLoaded", function() {
    // DebugMode
    var debugMode = 'off'; // options: 'phases', 'state' 
    ...
    function cardDraw(player) {
        if(debugMode == 'phases'){console.log('Card Draw');}
    ...
    function cardDrop(card, slot) {
        if(debugMode == 'phases'){console.log('Card Drop');}
    ...
    function cardAttack(card, slot) {
        if(debugMode == 'phases'){console.log('Card Attack');}
    ...
    function cardFlip(card, slot) {
        if(debugMode == 'phases'){console.log('Card Flip');}
    ...
    function checkCardStates() {
        if(debugMode == 'state'){console.log('Check all Card States');}
    ...
    function checkSlotStates() {
        if(debugMode == 'state'){console.log('Check all Slot States');}
